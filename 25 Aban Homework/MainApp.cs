...
void PrimeNumberOption(){
    ...
    if (ValidatedNumber < 1000){
        SPrime sprime = new SPrime();
        if(sprime.IsTrue(ValidatedNumber)) Console.WriteLine($"{ValidatedNumber} is a prime number.");
    ...
    if (ValidatedNumber >= 1000){
        PPrime pprime = new PPrime();
        if(pprime.IsTrue(ValidatedNumber)) Console.WriteLine($"{ValidatedNumber} is a prime number.");
        else Console.WriteLine($"{ValidatedNumber} is not a prime number");
...
void PalindromeNumberOption(){
    ...
    int ValidatedNumber = Keyboard.GetNumber();
    if (ValidatedNumber < 1000){
        SPalindrome spalindrome = new SPalindrome();
        if(spalindrome.IsTrue(ValidatedNumber)) Console.WriteLine($"{ValidatedNumber} is a palindrome number.");
    ...
    if (ValidatedNumber >= 1000){
        PPalindrome ppalindrome = new PPalindrome();
        if(ppalindrome.IsTrue(ValidatedNumber)) Console.WriteLine($"{ValidatedNumber} is a palindrome number.");
        else Console.WriteLine($"{ValidatedNumber} is not a palindrome number");
