...
public class Employee{
    ...
    public double CalculateSalary(
        int NumberOfMonths, int WorkingHours, 
    ...
    protected string StringPrepare(string EmployeeType){
        string BaseText = $"{FullName} Is a {EmployeeType}, Thier Phone number is {_PhoneNumber:D11}, Their Code-e Meli is {_CodeMeli:D10},";
        if (_IsMarried){
...
public class SimpleEmployee:Employee{
    ...
    {
        return base.StringPrepare("SimpleEmployee");
    }
...
public class ServiceEmployee:Employee{
    ...
    public override string ToString()
    {
        return base.StringPrepare("ServiceEmployee");
    }
...
public class ManagerEmployee:Employee{
    ...
    public double CalculateSalary(
        int NumberOfMonths, int WorkingHours, 
        double FamilySalary, float OverTime,int EmployeeRate
    ){
        return base.CalculateSalary(NumberOfMonths,WorkingHours,FamilySalary,OverTime,_EmployeeRate);
    }
    ...
    public override string ToString()
    {
        return base.StringPrepare("ManagerEmployee");
    }
...
public class CEOEmployee:Employee{
    ...
    public override string ToString()
    {
        return base.StringPrepare("CEOEmployee");
    }
